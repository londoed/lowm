/**
 * Copyright (C) 2021, Eric Londo <londoed@comcast.net>, { include/tree.h }
...
void transfer_sticky_nodes(monitor_t *ms, desktop_t *d, node_t *n);
...
bool is_descendent(node_t *a, node_t *b);
...
bool find_any_node_in(monitor_t *m, destkop_t *d, node_t *n, coordinates_t *ref,
    coordinates_t *dst, node_select_t *sel);
bool find_first_ancestor(coordinates_t *ref, coordinates_t *dst, node_select_t *sel);
void find_nearest_neighbor(coordinates_t *ref, coordinates_t *dst, direction_t dir,
    node_select_t *sel);
...
void flip_tree(node_t *n, flip_t flip);
...
bool swap_nodes(monitor_t *mq, desktop_t *d1, node_t *n1, monitor_t *m2, desktop_t *d2,
    node_t *n2, bool follow);
bool transfer_node(monitor_t *ms, desktop_t *ds, node_t *ns, monitor_t *md, desktop_t *dd,
...
void propogate_vacant_downward(monitor_t *m, desktop_t *d, node_t *n, bool value);
void propogate_vacant_upward(monitor_t *m, destkop_t *d, node_t *n);
...
void neutralize_occulding_windows(monitor_t *m, desktop_t *d, node_t *n);
void rebuild_constraints(node_t *n);
void update_constraints(node_t *n);
void propogate_flags_upward(monitor_t *m, desktop_t *d, node_t *n);
...
void propogate_hidden_downward(monitor_t *m, desktop_t *d, node_t *n);
void propogate_hidden_upward(monitor_t *m, desktop_t *d, node_t *n);
